...
• Sua geolocalização (GPS), coletada apenas durante o registro de presença,
  para confirmar que você está no local do evento.

Esses dados ficam armazenados de forma segura e são usados somente para essa
finalidade. Você pode revogar este consentimento e solicitar a exclusão dos
seus dados a qualquer momento na página "Meus dados", conforme a Lei Geral de
